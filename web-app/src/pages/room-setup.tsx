...
import { AutoGenerateDialog } from "@/feature/room/components/auto-generate-dialog";
          ...
          <div className="flex flex-col items-center gap-8 max-w-6xl w-full h-full">
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <CartoonButton
                ...
                className="mt-4"
              >
                <Sparkle size={28} className="shrink-0 text-gold" />
                <Typography variant={"label"}>Auto generate</Typography>
              </CartoonButton>
            </div>
